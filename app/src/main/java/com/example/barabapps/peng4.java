...
public class peng4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audioBackground = MediaPlayer.create(this, R.raw.bab2);
    ...
    public void home(View view) {
        Intent intent = new Intent(peng4.this, materi.class);
        startActivity(intent);
    }
    public void next(View view) {
        Intent intent = new Intent(peng4.this, peng5.class);
        startActivity(intent);
    }
    public void prev(View view) {
        Intent intent = new Intent(peng4.this, peng3.class);
        startActivity(intent);
    }
}
